...
const paramsSchema = {
  ...
  phpVersion: z.string().describe("The PHP version to set for the site. The client MUST validate this value against the available PHP versions from listStaticPhpVersionsTool before passing it, as this is plain text from the user."),
};

export const changeSitePhpVersionConfirmationStore = createConfirmationStore<Omit<typeof paramsSchema, never>>();

export const confirmChangeSitePhpVersionTool: ForgeToolDefinition<typeof paramsSchema> = {
