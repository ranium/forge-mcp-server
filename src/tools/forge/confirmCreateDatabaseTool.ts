...
const paramsSchema = {
  ...
  password: z.string().optional().describe("The password for the database user (optional, only shown if user is provided). The client MUST validate this is a valid password if provided."),
};

export const createDatabaseConfirmationStore = createConfirmationStore<typeof paramsSchema>();

export const confirmCreateDatabaseTool: ForgeToolDefinition<typeof paramsSchema> = {
