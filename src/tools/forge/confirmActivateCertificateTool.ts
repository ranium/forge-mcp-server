...
export const activateCertificateConfirmationStore = createConfirmationStore<Params>();

export const confirmActivateCertificateTool: ForgeToolDefinition<typeof paramsSchema> = {
    name: "confirm_activate_certificate",
    description: "Confirms the request to activate an SSL certificate for a site and returns a summary for user confirmation.",
