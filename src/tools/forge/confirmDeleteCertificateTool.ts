...
export const deleteCertificateConfirmationStore = createConfirmationStore<typeof paramsSchema>();

export const confirmDeleteCertificateTool: ForgeToolDefinition<typeof paramsSchema> = {
    name: "confirm_certificate_deletion",
    description: "Confirms the request to delete a certificate and returns a summary for user confirmation. This tool does not perform the operation, but returns a summary and expects the client to handle the confirmation logic.",
