...
const paramsSchema = {
    ...
    confirmationId: z.string().describe("This confirmationId must be obtained from confirmCertificateDeletionTool after explicit user confirmation. If an invalid or mismatched confirmationId is provided, the certificate deletion will be rejected.")
};
