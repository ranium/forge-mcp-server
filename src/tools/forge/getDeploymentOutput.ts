...
const paramsSchema = {
  serverId: z.string().describe("The ID of the server to get the deployment output for."),
  siteId: z.string().describe("The ID of the site to get the deployment output for."),
  deploymentId: z.string().describe("The ID of the deployment to get the output for."),
};
