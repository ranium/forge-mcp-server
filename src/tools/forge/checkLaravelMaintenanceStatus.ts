...
const paramsSchema = {
  serverId: z.string().describe("The ID of the server to check Laravel maintenance status for."),
  siteId: z.string().describe("The ID of the site to check Laravel maintenance status for."),
};
