...
const paramsSchema = {
  serverId: z.string().describe("The ID of the server to list databases for. The client MUST validate this value against the available servers from listServersTool before passing it."),
};
