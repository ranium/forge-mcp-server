...
const paramsSchema = {
  serverId: z.string().describe("The ID of the server to get Composer packages authentication for."),
  siteId: z.string().describe("The ID of the site to get Composer packages authentication for."),
};
